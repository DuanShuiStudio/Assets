...
namespace MoreMountains.Feedbacks
{
	...
	public class MMSpringFloat : MMSpringDefinition<float>
	{
		...
		[Tooltip("阻尼比决定了弹簧在受到干扰后变化的速度。当阻尼比值较低时，弹簧会振荡很长时间，而当阻尼比值接近1时，它会迅速停止振荡。 ")]
		[Range(0.01f, 1f)]
		...
		[Tooltip("频率决定了弹簧在受到干扰时振荡的速度。频率低意味着每秒振荡的次数较少，频率高则意味着每秒振荡的次数较多。 ")]
		...
		[Tooltip("这个弹簧趋向的数值，并且是它一旦停止振荡就会达到的数值。 ")]
