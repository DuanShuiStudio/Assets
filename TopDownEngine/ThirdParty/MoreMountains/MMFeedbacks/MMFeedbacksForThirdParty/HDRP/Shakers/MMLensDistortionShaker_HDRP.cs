...
{
    /// <summary>
    /// 将这个类添加到一个具有高动态范围渲染管线（HDRP）镜头畸变后期处理功能的相机上，它将能够通过接收事件来“抖动”其相关参数值。 
    /// </summary>
#if MM_HDRP
	[RequireComponent(typeof(Volume))]
#endif
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/MM Lens Distortion Shaker HDRP")]
